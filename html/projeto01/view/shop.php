...
<section ng-controller="destaque-controller">
	...
	<div class="container" id="destaque-produtos-container">
		...
		<div id="destaque-produtos" class="owl-carousel">
			...
			<div class="row item" ng-repeat="produto in produtos">
		...
		<button type="button" id="btn-destaque-prev"><i class="fa fa-angle-right"></i></button>-->

	</div>
	<div id="promocoes">
		
		<div class="row" ng-controller="destaque-controller">
