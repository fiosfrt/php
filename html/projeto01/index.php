...
$app->get('/produtos', function(){
    ...
    /*
    $scope.produtos.push({
      nome_prod_longo:"Smartphone Motorola Moto X Play Dual Desbloqueado Android 5.1",
...
$app->delete("/carrinhoRemoveAll-:id_prod", function($id_prod){
  ...
  $sql->query("CALL sp_carrinhosprodutostodos2_rem(".$carrinho['id_car'].", ".$id_prod.")");
...
$app->get("/calcular-frete-:cep", function($cep){
  ...
  $sql->query("UPDATE tb_carrinhos SET cep_car = '".$cep."', frete_car = ".$frete->getValor()." WHERE id_car = ".$carrinho['id_car']);
